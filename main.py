...
def btn_style2():
    ...
    border-width: 1px;
    color: white;
    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #4dffdb, stop: 1 #00cc7a);
    }

    QPushButton:pressed
    {
    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #00cc7a, stop: 1 #4dffdb);
    }
""")
    return styleBtn2
...
"}")
        ...
        self.btnMusica4.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica4.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica4.setStyleSheet(btn_style())
        self.btnMusica4.setObjectName("btnMusica4")
        self.gridLayout.addWidget(self.btnMusica4, 0, 2, 1, 1)
        self.btnMusica1 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica1.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica1.setMaximumSize(QtCore.QSize(300, 65))
        ...
        self.btnMusica6.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica6.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica6.setStyleSheet(btn_style())
        self.btnMusica6.setObjectName("btnMusica6")
        self.gridLayout.addWidget(self.btnMusica6, 0, 1, 1, 1)
        self.btnMusica5 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica5.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica5.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica5.setStyleSheet(btn_style())
        self.btnMusica5.setObjectName("btnMusica5")
        self.gridLayout.addWidget(self.btnMusica5, 1, 2, 1, 1)
        self.btnMusica3 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica3.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica3.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica3.setStyleSheet(btn_style())
        self.btnMusica3.setObjectName("btnMusica3")
        self.gridLayout.addWidget(self.btnMusica3, 1, 1, 1, 1)
        self.btnMusica2 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica2.setEnabled(False)
        self.btnMusica2.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica2.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica2.setStyleSheet(btn_style())
        self.btnMusica2.setObjectName("btnMusica2")
        self.gridLayout.addWidget(self.btnMusica2, 1, 0, 1, 1)
        self.btnMusica7 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica7.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica7.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica7.setStyleSheet(btn_style())
        self.gridLayout.addWidget(self.btnMusica7, 4, 2, 1, 1)
        self.btnMusica8 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica8.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica8.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica8.setStyleSheet(btn_style())
        self.gridLayout.addWidget(self.btnMusica8, 3, 0, 1, 1)
        self.btnMusica9 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica9.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica9.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica9.setStyleSheet(btn_style())
        self.gridLayout.addWidget(self.btnMusica9, 3, 2, 1, 1)
        self.btnMusica10 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica10.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica10.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica10.setStyleSheet(btn_style())
        self.gridLayout.addWidget(self.btnMusica10, 4, 1, 1, 1)
        self.btnMusica11 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnMusica11.setMinimumSize(QtCore.QSize(300, 65))
        self.btnMusica11.setMaximumSize(QtCore.QSize(300, 65))
        self.btnMusica11.setStyleSheet(btn_style())
        self.gridLayout.addWidget(self.btnMusica11, 4, 0, 1, 1)
        icon2 = QtGui.QIcon()
...
#        self.labelColorWheel.mouseMoveEvent = self.getPos
        ...
        self.btnMusica4.clicked.connect(self.pendrive)
        self.btnMusica5.clicked.connect(self.tocaMusicaClass)
        self.btnMusica6.clicked.connect(self.tocaMusicaCatolica)
        self.btnMusica7.clicked.connect(self.stop)
        self.btnMusica10.clicked.connect(self.unpause)
        self.btnMusica11.clicked.connect(self.pause)
        self.btnMusica9.clicked.connect(self.nextsong)
        self.btnMusica8.clicked.connect(self.prevsong)
...
##            pixmap = pixmap.scaled(900, 350, QtCore.Qt.KeepAspectRatio, QtCore.Qt.SmoothTransformation)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnMusica8.setIcon(QIcon(QPixmap("prev.png")))
        self.btnMusica8.setIconSize(QtCore.QSize(80, 80))
        self.btnMusica9.setIcon(QIcon(QPixmap("next.png")))
        self.btnMusica9.setIconSize(QtCore.QSize(80, 80))
        self.btnMusica10.setIcon(QIcon(QPixmap("play.png")))
        self.btnMusica10.setIconSize(QtCore.QSize(80, 80))
        self.btnMusica11.setIcon(QIcon(QPixmap("pause.png")))
        self.btnMusica11.setIconSize(QtCore.QSize(80, 80))
        self.btnMusica7.setIcon(QIcon(QPixmap("stop.png")))
        self.btnMusica7.setIconSize(QtCore.QSize(80, 80))
...
##        print("O RB marcado eh: " + str(Cena))
    ...
    def tocaSomCachoeira(self):
        pygame.mixer.music.load('cachoeira.mp3')
        pygame.mixer.music.play(-1)

    def tocaSomPassaros(self):
        pygame.mixer.music.load('passaros.mp3')
        pygame.mixer.music.play(-1)

    def tocaSomMar(self):
        pygame.mixer.music.load('mar.mp3')
        pygame.mixer.music.play(-1)
    ...
    def pendrive(self):
        ...
        for file in os.listdir(directory):
            if file.endswith('.mp3'):
                musicas_pendrive.append(file)

        pygame.mixer.music.load(musicas_pendrive[0])
        pygame.mixer.music.play()

    def popup(self):
        msgBox = QMessageBox()
        msgBox.setWindowTitle('Seletor - Sons de Natureza')
        msgBox.setIconPixmap(QPixmap('/obannerpopup2.png'))
